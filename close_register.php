...
$DB->set_field('teamsattendance', 'status', 'closed', ['id' => $session->id]);
...
redirect(new moodle_url('/mod/teamsattendance/view.php', ['id' => $id]), get_string('register_closed', 'mod_teamsattendance'));
